...
6. 本版本从高端住宅案例提炼设计语言；默认子风格 `quiet-poise` 在避免酒店化的同时，要求现代明式家具谱系、墙面饰面、东方抽象艺术、器物、材质与灯光共同建立身份，不能退化为稀疏的泛米色空间。
7. Finish-enabled 任务必须完成一个主要墙面与天花照明；只挂一幅“中国风”画、摆一个花瓶或保留空白天花均不能通过风格 QA。
