...
export const STYLE_KNOWLEDGE = {
  modern_east: { skillName: 'modern-east-style', knowledgeVersion: '0.3-production' },
  california_modern: { skillName: 'california-modern-style', knowledgeVersion: '0.2-production' },
  maximal_luxe: { skillName: 'maximal-luxe-style', knowledgeVersion: '0.2-production' },
    ...
    return [{
      ...
      content: JSON.stringify({
        ...
        output_requirement: [
          ...
          'Change only the furnishing and finish categories permitted by renovation_scope. For a finish-enabled request, treat unfinished surface appearance and generic construction downlights as editable: resolve at least one major wall plane, the visible ceiling and decorative-lighting composition, the principal furniture group, window treatment where appropriate, and a primary-secondary-accent material hierarchy. A wall may use mineral finish, timber or stone panel, woven wallcovering, patterned textile, or shallow upholstered panel only when supported by the selected Skill.',
          'Ceiling finish and decorative lighting may be redesigned, including a shallow applied perimeter reveal or cove, continuous indirect light, wall wash, picture or face-level light, and one room-scaled statement fixture. Existing generic downlights may be removed, reduced, or integrated into that coherent lighting system, but never move or conceal a structural beam, shift the slab plane, lower the room perceptibly, change a column, or move a door/window head. Do not leave a blank ceiling or settle for two isolated spotlights as the entire ceiling design.',
          'Keep the result a believable, fully resolved American residence at the source room scale. Furnish the usable zones completely with correctly scaled furniture, textiles, art, objects, and layered lighting. Follow the selected Skill for distinctive furniture lineage and materials; do not rely on a single symbolic artwork or accessory to communicate style. Where the selected Skill supports them, acrylic, cast resin, colored or smoked glass, lacquer, patterned textile, and other contemporary materials may appear as controlled premium accents, never as cheap plastic or random novelty.',
