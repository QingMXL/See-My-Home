...
For `finishes_and_furnishing` and other finish-enabled requests, treat the wall, floor, cabinet-front, structural-ceiling surface and decorative-lighting layer as a coordinated design system rather than leaving the photographed shell untouched. Resolve at least one major wall plane, the visible ceiling and lighting composition, the principal furniture group, window treatment where appropriate, and a primary-secondary-accent material hierarchy. Depending on the selected style, wall finishes may include mineral plaster, timber or stone panels, woven wallcovering, patterned textile, or shallow upholstered panels. Contemporary accent materials such as cast resin, smoked or colored glass, lacquer, or acrylic are allowed only when the selected Skill supports them and only as a controlled accent; they must look premium, buildable, and intentional rather than plastic or novelty-driven.

Existing generic construction downlights and unfinished surfaces are not immutable. When the editable scope permits, replace or integrate them into the selected style's complete ceiling and lighting scheme. Preserve the ceiling geometry and all structure, but do not leave a blank white ceiling with only isolated spotlights when the selected style calls for coves, reveals, decorative fixtures, wall wash, picture light, or face-level light.
