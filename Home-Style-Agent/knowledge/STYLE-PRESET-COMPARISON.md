...
| 视觉密度 | 中等且克制，约 50–65% | 中等且松弛，约 50–65% | 中高，约 60–75% |
| 主材 | 深浅木、哑光石、矿物/织物墙面、古铜、少量茶色新材料 | 浅木、石灰基/草编墙面、亚麻、陶土、自然石、少量树脂或玻璃 | 漆面木、强纹理石材、图案织物、天鹅绒、镜面、黄铜、Lucite/树脂 |
| 主色 | 暖象牙、灰褐、木棕、墨黑点缀 | 日晒白、沙色、蜂蜜木、鼠尾草 | 茄紫、酒红、祖母绿、墨黑、奶油色 |
| 家具 | 舒适当代主家具 + 一件抽象现代明式轮廓 | 深座、松弛、非成套复古与手作混搭 | 曲线、珠宝感、成组与收藏式搭配 |
...
|---|---|---|---|---|
| Modern East | 已完成 v0.3-production | 已完成 | 已完成 | 已有内部校对集 |
| California Modern | 已完成 v0.2-production | 已完成 | 已完成 | 已建立来源索引，待授权策略确认后归档原图 |
| Maximal Luxe | 已完成 v0.2-production | 已完成 | 已完成 | 已建立来源索引，待授权策略确认后归档原图 |
